...
class ScoreTest {
    ...
    void getPlayerStatus() {
        ...
        Assertions.assertThat(score.getGameCondition()).isEqualTo(GameCondition.find(cardScore, 2));
    }
    ...
    void getPlayerStatusNotContainAce() {
        ...
        final int cardScore = 13;
        Assertions.assertThat(score.getScore()).isEqualTo(cardScore);
        Assertions.assertThat(score.getGameCondition()).isEqualTo(GameCondition.find(cardScore, 3));
    }
}
